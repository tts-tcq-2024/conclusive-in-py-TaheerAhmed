...
Make more abstarct functions allowing for better abstraction
Use YAGNI principle  , Open close principle because it  feels like it can benifit the project more and make it more extensible code
